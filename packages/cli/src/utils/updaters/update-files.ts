...
import { RegistryItem, registryItemFileSchema } from "../../schema"
import { withYyc3Header } from "../../utils/brand-header"
...
import { transformNext } from "../../utils/transformers/transform-next"
...
export async function updateFiles(
  ...
  for (let index = 0; index < files.length; index++) {
    ...
    await fs.writeFile(filePath, withYyc3Header(content, filePath), "utf-8")
